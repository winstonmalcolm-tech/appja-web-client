      ...
      <div className='flex'>
        <div className='flex-1 w-full h-52 flex gap-5 mt-11'>
          ...
          <div className='flex flex-col h-full justify-center'>
            ...
            <button className="p-2 border-2 bg-transparent rounded-xl text-center" onClick={()=>document.getElementById('my_modal_1').showModal()}>Socials</button>
        ...
        <div className='flex-1 flex w-full justify-center items-center'>
          <h1 className='text-2xl'>{data.apps.length} apps published</h1>
        </div>
      </div>
